...
const objections = [
  ...
  },
  {
    ...
    a: "Tools require humans to operate them. AI employees operate themselves. That's the difference. We deploy agents that own functions — not copilots that assist with tasks.",
  },
  {
