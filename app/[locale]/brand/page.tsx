...
const colors = [
  { name: 'Electric Orange', hex: '#FF4C00', swatch: 'bg-[#FF4C00]' },
  { name: 'Charcoal', hex: '#1C1C1E', swatch: 'bg-[#1C1C1E]' },
        ...
        <section>
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--bg-card)] p-8">
            <ul className="space-y-3 text-[var(--text-secondary)] text-sm">
              ...
              <li>✅ Use charcoal or orange-on-light wordmark on light backgrounds</li>
              <li>✅ Use white or orange wordmark on dark backgrounds</li>
