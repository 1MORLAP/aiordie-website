...
const whatYouGet = [
  ...
  },
  {
    ...
    desc: "We run the numbers. Real cost of current headcount vs. AI direct report equivalent — for your specific business, not a generic model.",
  },
  {
...
const objections = [
  ...
  },
  {
    ...
    a: "Tools require humans to operate them. AI direct reports operate themselves. That's the difference. We deploy AI direct reports that own functions — not copilots that assist with tasks.",
  },
  {
    ...
    <>
      ...
      <section className="relative px-6 pt-16 sm:pt-24 pb-16 sm:pb-20 max-w-6xl mx-auto">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-black tracking-tighter text-white leading-none mb-6">
            Find Out Which Roles in Your Business Should Be AI Direct Reports
          </h1>
      ...
      <section className="bg-[#111111] border-y border-gray-800 px-6 py-24">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-400 mb-12 text-lg max-w-2xl">
            We don&apos;t sell theory. Every AI direct report type we recommend, we run internally. This website, our outreach, our ops — all of it is run by AI.
          </p>
      ...
      <section className="bg-[#111111] border-t border-gray-800 px-6 py-24">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-lg mb-10 max-w-xl mx-auto">
            Free. No pitch. No pressure. Just an honest look at where AI direct reports fit — or don&apos;t — in your company.
          </p>
