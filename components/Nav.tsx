    ...
    <header className="sticky top-0 z-50 border-b border-[var(--border)] bg-[var(--bg)]/95 backdrop-blur-sm">
      ...
      <div className="border-b border-[var(--border)] bg-[var(--bg-secondary)] px-6 py-1.5">
        <div className="max-w-6xl mx-auto flex items-center justify-center gap-3 text-xs text-[var(--text-muted)]">
          <span className="font-medium text-[var(--text-secondary)]">Ask your AI: We build it. You own it. You run it.</span>
          <a
            href="https://chatgpt.com/?q=Explain%20AI%20or%20Die%20pricing%20and%20model%3A%20Deploy%20%2B%20Train%20%2B%20Advise.%20Focus%20on%20client%20ownership%2C%20infrastructure%20control%2C%20and%20optional%20advisory."
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-[var(--text-primary)] transition-colors"
            title="Ask ChatGPT about AIorDie"
          >
          ...
          <a
            href="https://claude.ai/new?q=Summarize%20AI%20or%20Die%27s%20new%20model%3A%20we%20deploy%20AI%20teams%2C%20train%20clients%2C%20and%20offer%20optional%20advisory.%20Highlight%20why%20ownership%20matters."
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-[var(--text-primary)] transition-colors"
            title="Ask Claude about AIorDie"
          >
          ...
          <a
            href="https://www.perplexity.ai/search?q=AI%20or%20Die%20Deploy%20Train%20Advise%20model%20pricing%20site%3Aaiordie.now"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-[var(--text-primary)] transition-colors"
            title="Ask Perplexity about AIorDie"
          >
